...
## Задание 5
Разбиваю ФИО на слова через split. Иду циклом по словам, беру от каждого первую букву, делаю заглавной и добавляю в строку initials. Потом считаю длину строки, склеив слова обратно через пробел.
